...
namespace WindowsFormsApp10
{
    public partial class Form14 : Form
    {
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            ...
            if (p == "20")//ตัวแปรที่เรากำหนดเท่ากับ คำที่เราต้องการจะให้ใช้งานตามที่เรากำหนด
            {
                timer.Enabled = false;//ปิดการใช้งาน timer
                MessageBox.Show("การคูณ คือการดำเนินการทางคณิตศาสตร์อย่างหนึ่ง ทำให้เกิดการเพิ่มหรือลดจำนวนจำนวนหนึ่งเป็นอัตรา การคูณเป็นหนึ่งในสี่ของการดำเนินการพื้นฐานของเลขคณิตมูลฐาน (การดำเนินการอย่างอื่นได้แก่ การบวก การลบ และการหาร)");// การใช้ MessageBox โชว์ข้อความที่เรากำหนด
                Form15 f15 = new Form15();//การกำหนดค่า ปุ่ม ให้ทำงานโดยย้ายไปอีกหน้านึง
                f15.Show();//ตัวแปรให้โชว์ในค่าที่เรากำหนด
                this.Hide();//คำสั่งลบ form
            }
        ...
        private void Form14_Load(object sender, EventArgs e)
        {
            ...
            pictureBox6.SizeMode = PictureBoxSizeMode.StretchImage;//คำสั่งการกำหนดรูปให้ทำงานในคำสั่งค่าที่เรากำหนด ให้รูปมันเท่าๆกัน
            ...
            pictureBox6.Visible = false;//การปิดใช้งาน pictureBox
        }
        ...
        private void OnbuttonClick(object sender, EventArgs e)
        {
            ...
            pictureBox6.Visible = true;//การเปิดใช้งาน pictureBox
