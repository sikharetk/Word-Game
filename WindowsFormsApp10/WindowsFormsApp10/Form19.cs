...
namespace WindowsFormsApp10
{
    public partial class Form19 : Form
    {
        ...
        {
            string p = checkBox2.Text.ToString();//การกำหนดตัว string ให้เป็นตัวแปร p เท่ากับ  checkBox ใช้งานในค่าที่เรากำหนด
            {
                timer.Enabled = false;//ปิดการใช้งาน timer
                MessageBox.Show("หนังสือ เป็นสื่อที่รวบรวมของข้อมูล ประเภทตัวอักษร และ รูปภาพ ที่ลงในแผ่นกระดาษหรือวัสดุชนิดอื่น และรวมเข้าด้วยกัน ด้วยวิธีการ เย็บเล่ม หรือ ทากาว เข้าด้วยกันที่บริเวณขอบด้านใดด้านหนึ่ง โดยมีขนาดต่างๆกัน แต่มักจะไม่ทำใหญ่กว่าการจับและเปิดอ่านสะดวก หนังสือมักจะเป็นแหล่งรวบรวมข้อมูล ความรู้ วรรณกรรม ต่างๆ สำหรับหนังสือในรูปแบบที่เก็บในลักษณะอิเล็กทรอนิกส์ จะเรียกว่าหนังสืออิเล็กทรอนิกส์ หรือ อีบุ๊ก (e-book) การจัดพิมพ์ตามมาตรฐานจะมีหมายเลขไอเอสบีเอ็น (ISBN) เพื่อจะระบุประเทศและสำนักพิมพ์ หนังสือถือเป็นสื่อที่มีความเก่าแก่ และมีอายุยาวนานที่สุดในบรรดาสื่อทั้งหมด เคยมีการทำนายไว้ว่า เมื่อ วิทยุเกิดขึ้น หนังสือก็อาจจะหมดความสำคัญไป แต่เมื่อวิทยุถือกำเนิดขึ้นจริง หนังสือก็ยังคงได้รับความนิยมเหมือนเดิม หลังจากนั้นมีการทำนายว่า เมื่อ โทรทัศน์ เกิดขึ้น หนังสือก็อาจจะหมดความสำคัญไป แต่ก็ไม่เป็นเช่นนั้น เพราะหลังจาก โทรทัศน์เกิดขึ้น หนังสือก็ยังคงได้รับความสำคัญเหมือนเดิมไม่เปลี่ยนแปลงเช่นกัน");// การใช้ MessageBox โชว์ข้อความที่เรากำหนด
                Form20 f20 = new Form20();//การกำหนดค่า ปุ่ม ให้ทำงานโดยย้ายไปอีกหน้านึง
                f20.Show();//ตัวแปรให้โชว์ในค่าที่เรากำหนด
                this.Hide();//คำสั่งลบ form
            }
        }
