    ...
    public partial class Form20 : Form
    {
        ...
        private void checkBox3_CheckedChanged(object sender, EventArgs e)
        {
            string p = checkBox3.Text.ToString();//การกำหนดตัว string ให้เป็นตัวแปร p เท่ากับ  checkBox ใช้งานในค่าที่เรากำหนด
            {
                ...
                MessageBox.Show(" ปาก มีไว้เพื่อความสวยงานของรูปร่างหน้าตา เป็นสัดส่วนที่มีตั้งแต่เกิด");// การใช้ MessageBox โชว์ข้อความที่เรากำหนด
                Form21 f21 = new Form21();//การกำหนดค่า ปุ่ม ให้ทำงานโดยย้ายไปอีกหน้านึง
                f21.Show();//ตัวแปรให้โชว์ในค่าที่เรากำหนด
                this.Hide();//คำสั่งลบ form
            }
        }
