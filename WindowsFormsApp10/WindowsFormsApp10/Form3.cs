...
namespace WindowsFormsApp10
{
    public partial class Form3 : Form
    {
        ...
        private void button27_Click(object sender, EventArgs e)
        {
            ...
            if (p == "CAR") //ตัวแปรที่เรากำหนดเท่ากับ คำที่เราต้องการจะให้ใช้งานตามที่เรากำหนด
            {
                timer.Enabled = false; //ปิดการใช้งาน timer
                MessageBox.Show("รถยนต์หมายถึง ยานพาหนะทางบกที่ขับเคลื่อนที่ด้วยพลังงานอย่างใดอย่างหนึ่งและถ่ายทอดลงสู่ล้อ เพื่อพาผู้ขับ ผู้โดยสาร หรือสิ่งของ ไปยังจุดหมายปลายทาง ปัจจุบัน รถยนต์โดยส่วนมากได้รับการออกแบบอย่างซับซ้อนในทางวิศวกรรม และหลากหลายประเภท ตามความเหมาะสมของการใช้งาน หรือใช้สำหรับงานเฉพาะกิจ");// การใช้ MessageBox โชว์ข้อความที่เรากำหนด
                Form5 f5 = new Form5();//การกำหนดค่า ปุ่ม ให้ทำงานโดยย้ายไปอีกหน้านึง
                f5.Show();//ตัวแปรให้โชว์ในค่าที่เรากำหนด
                this.Hide();//คำสั่งลบ form
            }
        ...
        {
            pictureBox1.Visible = true; pictureBox1.Visible = true; //คำสั่งการเปิดใช้งานรูปที่ซ่อนอยู่
