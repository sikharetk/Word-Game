...
namespace WindowsFormsApp10
{
    ...
    public partial class Form22 : Form
    {
        ...
        private void button27_Click(object sender, EventArgs e)
        {
            ...
            if (p == "PENCIL")//ตัวแปรที่เรากำหนดเท่ากับ คำที่เราต้องการจะให้ใช้งานตามที่เรากำหนด
            {
                timer.Enabled = false;//ปิดการใช้งาน timer
                MessageBox.Show("ดินสอ สิ่งประดิษฐ์ที่ทำด้วยไม้แท่งเล็กๆ ยาวประมาณ 7 นิ้ว บรรจุภายในด้วยแกรไฟต์ นับว่าเป็นเครื่องมือของการขีดเขียนที่มีราคาถูกที่สุด ในการทำงานด้านการเขียนต่างๆ ที่ยังไม่แน่ใจในความถูกต้อง และอาจจะมีการแก้ไขเปลี่ยนแปลงผลงานต่างๆ อาทิเช่น งานวาดรูป งานออกแบบเสื้อผ้า ฯลฯ ไปจนถึงสูตรทำระเบิดนิวเคลียร์ ต่างก็เกิดขึ้นจากดินสอทั้งนั้น");// การใช้ MessageBox โชว์ข้อความที่เรากำหนด
                Form24 f24 = new Form24();//การกำหนดค่า ปุ่ม ให้ทำงานโดยย้ายไปอีกหน้านึง
                f24.Show();//ตัวแปรให้โชว์ในค่าที่เรากำหนด
                this.Hide();//คำสั่งลบ form
            }
