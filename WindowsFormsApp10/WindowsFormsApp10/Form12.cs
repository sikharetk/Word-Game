...
namespace WindowsFormsApp10
{
    public partial class Form12 : Form
    {
        ...
        private void button27_Click(object sender, EventArgs e)
        {
            ...
            if (p == "TIGER")//ตัวแปรที่เรากำหนดเท่ากับ คำที่เราต้องการจะให้ใช้งานตามที่เรากำหนด
            {
                timer.Enabled = false;//ปิดการใช้งาน timer
                MessageBox.Show("เสือ จัดเป็นสัตว์นักล่าที่มีความสง่างามในตัวเอง โดยเฉพาะเสือขนาดใหญ่ที่แลดูน่าเกรงขราม ไม่ว่าจะเป็นเสือโคร่งหรือเสือดาว ผู้ที่พบเห็นเสือในครั้งแรกย่อมเกิดความประทับใจในความสง่างาม แต่ในขณะเดียวกันก็เกิดความหวาดหวั่นเกรงขามในพละกำลังและอำนาจภายในตัวของพวกมัน เสือจึงได้รับการยกย่องให้เป็นราชาแห่งสัตว์ปา และเป็นจ้าวแห่งนักล่าอย่างแท้จริง");// การใช้ MessageBox โชว์ข้อความที่เรากำหนด
                Form13 f13 = new Form13();//การกำหนดค่า ปุ่ม ให้ทำงานโดยย้ายไปอีกหน้านึง
                f13.Show();//ตัวแปรให้โชว์ในค่าที่เรากำหนด
                this.Hide();//คำสั่งลบ form
            }
