...
namespace WindowsFormsApp10
{
    public partial class Form24 : Form
    {
        ...
        private void button27_Click(object sender, EventArgs e)
        {
            ...
            if (p == "FAMILY")//ตัวแปรที่เรากำหนดเท่ากับ คำที่เราต้องการจะให้ใช้งานตามที่เรากำหนด
            {
                timer.Enabled = false;//ปิดการใช้งาน timer
                MessageBox.Show(" ครอบครัว คือกลุ่มของบุคคลที่สืบเชื้อสายมาจากบรรพบุรุษเดียวกัน มีความใกล้ชิดกัน และอาศัยในที่เดียวกัน ความหมายของครอบครัวในทางพันธุศาสตร์จะพิจารณาถึงความสัมพันธ์ทางสายเลือดเป็นหลัก แต่ในสังคม คนทั่วไปมักจะเข้าใจความหมายของครอบครัวในทางภาพลักษณ์มากกว่าทางพันธุศาสตร์");// การใช้ MessageBox โชว์ข้อความที่เรากำหนด
                Form25 f25 = new Form25();//การกำหนดค่า ปุ่ม ให้ทำงานโดยย้ายไปอีกหน้านึง
                f25.Show();//ตัวแปรให้โชว์ในค่าที่เรากำหนด
                this.Hide();//คำสั่งลบ form
            }
