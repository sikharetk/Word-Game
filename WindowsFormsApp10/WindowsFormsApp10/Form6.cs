...
namespace WindowsFormsApp10
{
    public partial class Form6 : Form
    {
        ...
        private void button27_Click(object sender, EventArgs e)
        {
            ...
            if (p == "HOME")//ตัวแปรที่เรากำหนดเท่ากับ คำที่เราต้องการจะให้ใช้งานตามที่เรากำหนด
            {
                timer.Enabled = false;//ปิดการใช้งาน timer
                MessageBox.Show("บ้าน เป็นแหล่งที่อยู่ของคน ไม่ว่าจะคนรวยหรือจน ต้องมีบ้านเที่อยู่อาศัยอยู่เป็นที่พักกายและใจ");// การใช้ MessageBox โชว์ข้อความที่เรากำหนด
                Form7 f7 = new Form7();//การกำหนดค่า ปุ่ม ให้ทำงานโดยย้ายไปอีกหน้านึง
                f7.Show();//ตัวแปรให้โชว์ในค่าที่เรากำหนด
                this.Hide();//คำสั่งลบ form
            }
