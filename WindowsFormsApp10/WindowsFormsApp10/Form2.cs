...
namespace WindowsFormsApp10
{
    public partial class Form2 : Form
    {
        ...
        private void button27_Click(object sender, EventArgs e)
        {
            ...
            if (p == "CAT")                     //ตัวแปรที่เรากำหนดเท่ากับ คำที่เราต้องการจะให้ใช้งานตามที่เรากำหนด
            {
                timer.Enabled = false;          //ปิดการใช้งาน timer
                MessageBox.Show("  แมว หรือชื่อทางวิทยาศาสตร์ว่า 'Felis Catus' มีกำเนิดขึ้นบนโลกมากกว่า 50 ล้านปีมาแล้ว นักชีววิทยาค้นพบว่าบรรพบุรุษของแมวถือกำเนิดขึ้นกว่า 50 ล้านปีมาแล้ว เป็นสัตว์เลี้ยงลูกด้วยนมและกินเนื้อเป็นอาหาร เรียกว่า Miacis และได้วิวัฒนาการจนเริ่มมีลักษณะคล้ายแมวเมื่อ 10 ล้านปีก่อน ขนาดและรูปร่างใกล้เคียงกับแมวป่าที่มีเขี้ยวขนาดใหญ่เรียกว่า Dinistis"); // การใช้ MessageBox โชว์ข้อความที่เรากำหนด
                Form3 f3 = new Form3(); //การกำหนดค่า ปุ่ม ให้ทำงานโดยย้ายไปอีกหน้านึง
                f3.Show(); //ตัวแปรให้โชว์ในค่าที่เรากำหนด
                this.Hide(); //คำสั่งลบ form
