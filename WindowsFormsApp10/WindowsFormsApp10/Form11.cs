...
namespace WindowsFormsApp10
{
    public partial class Form11 : Form
    {
        ...
        private void button27_Click(object sender, EventArgs e)
        {
            ...
            if (p == "ELEPHANT")//ตัวแปรที่เรากำหนดเท่ากับ คำที่เราต้องการจะให้ใช้งานตามที่เรากำหนด
            {
                timer.Enabled = false;//ปิดการใช้งาน timer
                MessageBox.Show("ช้าง เป็นสัตว์เลี้ยงลูกด้วยน้ำนมขนาดใหญ่วงศ์ Elephantidae โดยแบ่งเป็นสองสกุล ได้แก่ Elephas และ Loxodonta ช้างในปัจจุบันเหลือ 3 สปีชีส์ คือ ช้างแอฟริกา, ช้างป่าแอฟริกา และช้างเอเชีย (หรือที่รู้จักกันในชื่อ ช้างอินเดีย) ส่วนสปีชีส์และสกุลอื่นของวงศ์ Elephantidae ล้วนสูญพันธุ์ไปหมดแล้ว บางสปีชีส์หรือสกุลสูญพันธุ์ไปตั้งแต่ยุคน้ำแข็งครั้งหลังสุด ถึงแม้ว่าช้างแมมมอธในรูปแคระอาจสืบสายพันธุ์ต่อมาจนถึง 2,000 ปีก่อนคริสตกาล[1] ช้างและสัตว์ในวงศ์ Elephantidae อื่น ๆ เคยถูกจัดเป็นประเภทเดียวกับสัตว์หนังหนาอื่น ๆ ชื่อว่าอันดับ Pachydermata ซึ่งปัจจุบันเลิกใช้แล้ว");// การใช้ MessageBox โชว์ข้อความที่เรากำหนด
                Form12 f12 = new Form12();//การกำหนดค่า ปุ่ม ให้ทำงานโดยย้ายไปอีกหน้านึง
                f12.Show();//ตัวแปรให้โชว์ในค่าที่เรากำหนด
                this.Hide();//คำสั่งลบ form
            }
