...
namespace WindowsFormsApp10
{
    public partial class Form9 : Form
    {
        ...
        private void button27_Click(object sender, EventArgs e)
        {
            ...
            if (p == "BIRD")//ตัวแปรที่เรากำหนดเท่ากับ คำที่เราต้องการจะให้ใช้งานตามที่เรากำหนด
            {
                timer.Enabled = false;//ปิดการใช้งาน timer
                MessageBox.Show("สัตว์ปีก หรือ นก (รวมถึง ไก่, เป็ด, ห่าน, ไก่ฟ้า) จัดอยู่ในไฟลัมสัตว์มีแกนสันหลัง ชั้น Aves (คำว่า Aves เป็นภาษาละติน หมายถึง นก) โดยมีลักษณะทั่วไปคือ เป็นสัตว์ทวิบาท เลือดอุ่น ออกลูกเป็นไข่ รยางค์คู่หน้าเปลี่ยนแปลงไปเป็นปีก มีขนนก และมีกระดูกที่กลวงเบา");// การใช้ MessageBox โชว์ข้อความที่เรากำหนด
                Form10 f10 = new Form10();//การกำหนดค่า ปุ่ม ให้ทำงานโดยย้ายไปอีกหน้านึง
                f10.Show();//ตัวแปรให้โชว์ในค่าที่เรากำหนด
                this.Hide();//คำสั่งลบ form
            }
